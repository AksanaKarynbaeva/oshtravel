...
class _HomeViewState extends State<HomeView> {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetCardRow(widget: CardHotel(networkImage: roomRandomUtil(), akchasy:"12345678" , name: randomNameHotelUtil(),),),
          const SliverToBoxAdapter(
            child: SizedBox(
              height: 20,
            ),
  ...
  WidgetCardRow(widget: CardHotel(networkImage: roomRandomUtil(), akchasy:"12345678" , name: nameRandomTypeUtil(),),),
